...
private static void inicializarVehiculos(){
        ...
        Marca mRenault = new Marca("Renault", "Francia");
        Marca mFord = new Marca("Ford", "Estados Unidos");
        Marca mIveco = new Marca("Iveco", "Italia");
        Marca mMercedes = new Marca("Mercedes", "Alemania");
